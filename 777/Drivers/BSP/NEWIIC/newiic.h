...
#define IIC_SCL_GPIO_PORT1               GPIOD
#define IIC_SCL_GPIO_PIN1                GPIO_PIN_2
#define IIC_SCL_GPIO_CLK_ENABLE1()       do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define IIC_SDA_GPIO_PORT1               GPIOD
#define IIC_SDA_GPIO_PIN1                GPIO_PIN_4
#define IIC_SDA_GPIO_CLK_ENABLE1()       do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */
...
#define IIC_SCL1(x)        do{ x ? \
                              HAL_GPIO_WritePin(IIC_SCL_GPIO_PORT1, IIC_SCL_GPIO_PIN1, GPIO_PIN_SET) : \
                              HAL_GPIO_WritePin(IIC_SCL_GPIO_PORT1, IIC_SCL_GPIO_PIN1, GPIO_PIN_RESET); \
                          }while(0)       /* SCL */
#define IIC_SDA1(x)        do{ x ? \
                              HAL_GPIO_WritePin(IIC_SDA_GPIO_PORT1, IIC_SDA_GPIO_PIN1, GPIO_PIN_SET) : \
                              HAL_GPIO_WritePin(IIC_SDA_GPIO_PORT1, IIC_SDA_GPIO_PIN1, GPIO_PIN_RESET); \
                          }while(0)       /* SDA */
#define READ_SDA			HAL_GPIO_ReadPin(IIC_SDA_GPIO_PORT1, IIC_SDA_GPIO_PIN1) /* 读取SDA */							
